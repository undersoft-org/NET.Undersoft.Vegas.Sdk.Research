...
{   
    public class InstantFigureReferenceCompiler
    {
        ...
        {          
            if (type == typeof(string) || type.IsArray)
            {
                ...
                if (member is MemberRubric && ((MemberRubric)member).FigureField != null)
                {
                    ...
                    CreateMarshalAttribute(field, member, (MarshalAsAttribute)((MemberRubric)member).FigureField.GetCustomAttributes().First());
                }
                else
                {
