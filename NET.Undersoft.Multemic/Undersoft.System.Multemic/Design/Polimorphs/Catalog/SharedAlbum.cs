...
namespace System.Multemic
{
    public abstract class SharedAlbum<V> : CardBook<V>
    {
        ...
        protected ManualResetEventSlim waitRead = new ManualResetEventSlim(true, 127);
        protected ManualResetEventSlim waitWrite = new ManualResetEventSlim(true, 255);
        protected ManualResetEventSlim waitRehash = new ManualResetEventSlim(true, 511);
        ...
        public SharedAlbum(int capacity = 16, HashBits bits = HashBits.bit64) : base(capacity, bits)
        {      
        }
