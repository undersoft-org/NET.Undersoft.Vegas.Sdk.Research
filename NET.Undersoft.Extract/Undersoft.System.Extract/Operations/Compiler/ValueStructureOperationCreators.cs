...
namespace System.Extract
{
    ...
    {
        public static void CreateValueObjectToPointer(TypeBuilder tb)
        {
        ...
        public static void CreateValueObjectToByteArrayRef(TypeBuilder tb)
        {
        ...
        public static void CreateValueObjectToNewByteArray(TypeBuilder tb)
        {
            var structToPtrMethod = tb.DefineMethod("ValueStructureToBytes",
                                             MethodAttributes.Public | MethodAttributes.HideBySig | MethodAttributes.Virtual,
                                             typeof(byte[]),
        ...
        public static void CreateValueTypeToNewByteArray(TypeBuilder tb)
        {
            var structToPtrMethod = tb.DefineMethod("ValueStructureToBytes",
                                             MethodAttributes.Public | MethodAttributes.HideBySig | MethodAttributes.Virtual,
                                             typeof(byte[]),
        ...
        public static void CreateValueObjectToNewPointer(TypeBuilder tb)
        {
            var structToPtrMethod = tb.DefineMethod("ValueStructureToPointer",
                                             MethodAttributes.Public | MethodAttributes.HideBySig | MethodAttributes.Virtual,
                                             typeof(byte*),
        ...
        public static void CreatePointerToValueObject(TypeBuilder tb)
        {
        ...
        public static void CreatePointerToValueType(TypeBuilder tb)
        {
            var ptrToValueStructureMethod = tb.DefineMethod("PointerToValueStructure",
                                             MethodAttributes.Public | MethodAttributes.HideBySig | MethodAttributes.Virtual,
                                             typeof(void),
        ...
        public static void CreateByteArrayToValueObject(TypeBuilder tb)
        {
        ...
        public static void CreateByteArrayToValueType(TypeBuilder tb)
        {
            var ptrToValueStructureMethod = tb.DefineMethod("BytesToValueStructure",
                                             MethodAttributes.Public | MethodAttributes.HideBySig | MethodAttributes.Virtual,
                                             typeof(void),
